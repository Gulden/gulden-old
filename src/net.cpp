...
void ThreadSocketHandler()
{
    ...
    loop
    {
        ...
        timeout.tv_sec  = 0;
        timeout.tv_usec = 9924; // frequency to poll pnode->vSend
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"107.170.142.183", "seed-002-guldencoin.nl"},
    {"185.27.173.32", "seed-003.guldencoin.net"},
    {"185.27.173.33", "seed-004.guldencoin.org"},
    {"185.27.173.34", "seed-005-guldencoin.nl"},
    {"46.21.171.254", "seed-006.guldencoin.net"},
    {"46.21.167.139", "seed-007.guldencoin.org"},
    {"46.21.167.138", "seed9.guldencoin.com"},
    {"188.226.149.20", "seed-009.guldencoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"Testnet Seed", "seedtest.guldencoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Guldencoin is probably already running."), addrBind.ToString().c_str());
        else
